...
# 输出结果excel保存位置
save_excel_path = r"D:\data\lstSimulate\Result\RF\4\\"

# RMSE\R2\BIAS 保存位置
save_RMSE_path = r"D:\data\lstSimulate\Result\RF\indicator\4\4_" +str(trainstation[0]) +'_'+str(teststation[0]) + r"\\RMSE.xlsx"
save_r2_path = r"D:\data\lstSimulate\Result\RF\indicator\4\4_" +str(trainstation[0]) +'_'+str(teststation[0])+ r"\\r2.xlsx"
save_MAE_path = r"D:\data\lstSimulate\Result\RF\indicator\4\4_" +str(trainstation[0]) +'_'+str(teststation[0])+ r"\\MAE.xlsx"
save_bias_path = r"D:\data\lstSimulate\Result\RF\indicator\4\4_" +str(trainstation[0]) +'_'+str(teststation[0])+ r"\\bias.xlsx"
bias_save = []
RMSE_save = []
r2_save = []
MAE_save = []
...
for i in testyear:
	for station in teststation:
		...
		# 画图检验
		plt.plot(y_pred , 'b', label='prediction', linewidth=2)
		plt.plot(y_test , 'r', label='real', linewidth=1)
		plt.legend(loc='best')
		plt.ylim((250, 350))
		# plt.show()
...
print(trainyear, trainstation, '---', 'all', station,  rmse,r2,bias)
# # 画图检验

...
param_test = {'n_estimators':range(150,250,10),
			   'max_depth':range(10,200,10),
			   'max_features':['auto','log2','sqrt'],
			   'min_samples_split':[2,5,10],
			   'min_samples_leaf':[1,2,4,8]}
RFR_search = RandomForestRegressor(
random_state=0,n_jobs=-1,oob_score=True,n_estimators=220,max_features='auto',bootstrap=True
)
grid_search = GridSearchCV(RFR_search,param_test,cv=3,scoring='r2')
...
# # plt.bar(range(num_feature), importances[indicates],align = "center")
# # plt.xticks(range(num_feature),[features[i] for i in indicates], rotation = "45")
